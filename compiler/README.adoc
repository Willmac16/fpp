...
[source,bash]
----
% export FPP_JAVA_HOME=/Library/Java/JavaVirtualMachines/openjdk17/Contents/Home
----
...
. Install GraalVM for JDK 17.
For example, download Oracle GraalVM for JDK 17 from
...
[source,bash]
----
% export GRAALVM_JAVA_HOME=/Library/Java/JavaVirtualMachines/graalvm-jdk-17/Contents/Home
